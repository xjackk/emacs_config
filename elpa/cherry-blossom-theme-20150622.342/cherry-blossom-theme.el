...
(custom-theme-set-faces
 ...
 ;; old is #8c86e4 ! (foreground)
 ;; cherry color: #FFB5D8
 '(mode-line
   ((((class color) (min-colors 88)) (:background "#222222" :foreground "#bebbf2"))
    (t (:background "#2b283d" :box nil :foreground "#8c86e4" :height 85))))

 '(mode-line-inactive
   ((((class color) (min-colors 88)) (:background "#111111" :foreground "#2d2a57"))
    (t (:weight light :box nil :background "#202339" :foreground "#2d2a57" :inherit (mode-line)))))
